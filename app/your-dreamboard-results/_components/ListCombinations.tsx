  ...
  return (
    <div className="container">
      ...
      {/* <div className="mb-8">
        ...
        <SliderDreamStyle items={dreamRoomsArrScaled} />
      </section>
      ...
      <section className="py-[50px]">
        <TitleBigWithSubtitle subTitle="explore your" title="Dreamboards." />
        <SliderDreamBoards items={dreamBoardsArrScaled} />
      </section>
            ...
            {results
              ...
              .map((combination: any, index: number) => (
                <ItemCombination
                  ...
                  staticCombinationMetadata={staticData?.combinationMetadata}
                />
              ))}
          </div>
        </div>
